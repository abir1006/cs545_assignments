package miu.example.Lab7_backend.aspects;

import miu.example.Lab7_backend.entities.Logger;
import miu.example.Lab7_backend.services.LoggerService;
...
import miu.example.Lab7_backend.annotations.ExecutionTime;
...
public class LoggerAspect {
    ...
    @After("execution(* miu.example.Lab7_backend.controllers.UserController+.*(..))")
    ...
    @After("execution(* miu.example.Lab7_backend.controllers.PostController+.*(..))")
    ...
    @After("execution(* miu.example.Lab7_backend.controllers.CommentController+.*(..))")
