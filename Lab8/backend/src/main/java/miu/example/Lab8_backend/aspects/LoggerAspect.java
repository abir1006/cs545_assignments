package miu.example.Lab8_backend.aspects;

import miu.example.Lab8_backend.entities.Logger;
import miu.example.Lab8_backend.services.LoggerService;
...
public class LoggerAspect {
    ...
    @After("execution(* miu.example.Lab8_backend.controllers.UserController+.*(..))")
    ...
    @After("execution(* miu.example.Lab8_backend.controllers.PostController+.*(..))")
    ...
    @After("execution(* miu.example.Lab8_backend.controllers.CommentController+.*(..))")
